...
{id:"s03",act:1,kind:"choice",title:"나는 무엇을 보고 투자하는가?",
 ...
 caption:"투자 판단에는 개인의 목적과 가치관 절대적 관여.",
 note:["여러분은 성장성, 안정성, 수익성 중 무엇을 가장 중요하게 보시나요?","그리고 이 기준이 회사에서 일할 때도 똑같이 작동하고 있을까요?"]},

{id:"s04",act:1,kind:"choice",title:"같은 회사를 보고도 달라지는 판단",
 body:["가상의 회사 A는 매출 성장률 +30%, 시장점유율 상승, 향후 시장 규모는 확대,","높은 변동성, 현재는 적자.","여러분이라면 이 회사에 투자하시겠습니까?"],
...
{id:"s12",act:1,kind:"content",title:"이 문제는 '우리 팀'에도 똑같이 적용해 볼수 있습니다",
 body:[],
...
{id:"s14",act:2,kind:"scale",title:"① 우리 팀의 성장 가능성은?",
...
{id:"s15",act:2,kind:"wordcloud",title:"② 지금 이대로 하면 되는가?",
...
{id:"s19",act:2,kind:"choiceplus",title:"그래서, 여러분이라면\n우리 팀에 투자하시겠습니까?",
