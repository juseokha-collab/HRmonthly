...
{id:"s08",act:1,kind:"content",title:"최종(?) 가치는 누가 결정하는가?",
 ...
 rightPanel:{
   title:"손해인 커리어에서 배우는\n직장인의 성장 공식",
   tagline:"「전문성이 없는 사람」이 아니라\n「연결할 수 있는 사람」이 되다",
   timeline:[
     {label:"20대의 선택",desc:"문과 출신 → NVIDIA 인턴"},
     {label:"모르는 것을 숨기지 않고 질문",desc:"기술자에게 배우고, AI·GPU를 이해"},
     {label:"자신만의 역할 발견",desc:"기술을 만드는 사람 × 기술을 이해하는 사람 × 사람에게 설명하는 사람"},
     {label:"역할의 확장",desc:"마케팅 → 개발자 커뮤니티 → AI 교육 → 사업개발"},
     {label:"2026년",desc:"업스테이지 AI 교육 부문 대표/부사장"}
   ],
   formula:{heading:"손해인의 성장 공식",equation:"성장 = 새로운 경험 × 학습하는 태도 × 나만의 연결능력",note:"처음부터 '내 전문성'을 갖고 있었던 것이 아니라\n경험을 연결하면서 '나만의 전문성'을 만들어갔다."},
   keyQuestion:{q1:"나는 지금 무엇을 잘하는가?",lead:"보다 중요한 질문은",q2:"“내가 가진 경험들을 무엇과 연결하면 새로운 가치가 만들어지는가?”"}
 },
