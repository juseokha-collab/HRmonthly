...
{id:"s00b",act:1,kind:"content",
 warmup:{
   ...
   intro:[
     "지금 당신의 삶에서 '있어서 참 다행이다'라고 생각하는 사람이나, 생각하는 것은 무엇인가요?",
     "그것을 얻거나 지키기 위해 내가 했던 노력은 무엇이었나요?"
   ],
   lists:[
     {title:"Self Awareness",items:[
       "우리는 매 순간 좋다/나쁘다, 중요하다/중요하지 않다고 판단합니다. 당신은 무엇을 기준으로 판단합니까?",
       "수많은 판단의 기준 중에서 당신에게 가장 중요한 Value 하나를 고른다면 무엇입니까?",
       "그 가치는 언제부터 나에게 중요해졌을까요?",
       "고등학교 시절로 돌아가서 다시 삶을 살게 된다면, 가장 크게 달라질 당신의 선택은 무엇일까요?",
     ...
     {title:"Interpersonal",items:[
       "사람을 선택하거나 함께 일할 때, 당신이 가장 중요하게 보는 기준은 무엇입니까?",
       "그렇다면 주식·부동산·상품 같은 자산을 선택할 때 가장 중요하게 보는 기준은 무엇입니까?",
       "사람을 판단하는 기준과 자산을 판단하는 기준은 같습니까, 다릅니까? 왜 그렇습니까?",
       "사람을 믿는다는 것을 무엇이라고 생각합니까?",
       "말해도 되는 거짓말과 절대 해서는 안되는 거짓말의 경계는 무엇입니까?"
     ]}
   ]
 }},
