...
{id:"s02",act:1,kind:"choice",title:"1억 원이 생긴다면,\n어디에 투자하시겠습니까?",
 ...
 options:[{k:"stock",l:"주식"},{k:"realestate",l:"부동산"},{k:"deposit",l:"예금 / 채권"},{k:"self",l:"나 자신"},{k:"relationship",l:"가족 / 관계"},{k:"etc",l:"기타"}],
 caption:"같은 1억원, 투자 목적에 따라 달라지는 기대 가치",
...
{id:"s11",act:1,kind:"scale",hidePrompt:true,title:"만약 나에게도 '주가'가 있다면?",
...
{id:"s12",act:1,kind:"content",title:"'우리 팀'에도 적용해 생각해 본다면",
 body:[],
